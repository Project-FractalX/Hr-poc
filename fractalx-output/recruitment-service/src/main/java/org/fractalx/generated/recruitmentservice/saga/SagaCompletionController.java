package org.fractalx.generated.recruitmentservice.saga;
 ...
 *
 * <p>Sagas managed for recruitment-service:
 * <ul>
 *   <li>{@code hire-employee-saga} — hireEmployee()</li>
 * </ul>
 *
...
public class SagaCompletionController {
    ...
    public ResponseEntity<Void> onSagaComplete(
        ...
        try {
            ...
            // TODO: finalize business state (e.g., mark Recruitment as CONFIRMED)
    ...
    public ResponseEntity<Void> onSagaFailed(
        ...
        try {
            ...
            // TODO: revert business state (e.g., mark Recruitment as CANCELLED)
            return ResponseEntity.ok().build();
        } catch (Exception e) {
