...
public class PayrollService {
    ...
    public void cancelSetupPayroll(Long employeeId, BigDecimal salary) {
        ...
        payrollRepository.findTopByEmployeeIdAndStatusOrderByCreatedAtDesc(employeeId, "ACTIVE").ifPresent(r -> {
    ...
    public void deductLeave(Long employeeId, Integer leaveDays) {
        ...
        LocalDate now = LocalDate.now();
        payrollRepository.findByEmployeeIdAndPayYearAndPayMonth(employeeId, now.getYear(), now.getMonthValue()).ifPresent(record -> {
