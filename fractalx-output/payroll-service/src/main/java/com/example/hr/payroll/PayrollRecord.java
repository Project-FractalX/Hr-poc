...
public class PayrollRecord {
    ...
    @Column(nullable = false)
    private String // "ACTIVE", "PROCESSED", "CANCELLED"
    status;
    ...
    public Integer getLeaveDaysDeducted() {
        return leaveDaysDeducted;
    }

    public void setLeaveDaysDeducted(Integer leaveDaysDeducted) {
        this.leaveDaysDeducted = leaveDaysDeducted;
    }
