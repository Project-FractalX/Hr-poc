# 🗄️ Data Architecture: department-service
...
| **Connection URL** | `jdbc:h2:mem:department_service` |
...
3. Access H2 Console: `http://localhost:8085/h2-console`
   - JDBC URL: `jdbc:h2:mem:department_service`
...
fractalx:
  modules:
    ...
    department-service:
      datasource:
        url: jdbc:mysql://localhost:3306/department_service_db
        username: root
...
The saga orchestrator calls this service's methods via **NetScope gRPC on port 18085**.

| Step # | Forward Call | Compensation | Triggered When |
| :---: | :--- | :--- | :--- |
| 2 | `assignToDepartment()` | `cancelAssignToDepartment()` | Step 2 of the saga |
...
| Step # | Forward Call | Compensation | Triggered When |
| :---: | :--- | :--- | :--- |
| 2 | `incrementHeadcount()` | `cancelIncrementHeadcount()` | Step 2 of the saga |
