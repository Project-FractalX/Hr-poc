...
public class CommunicationController {
    ...
    public ResponseEntity<List<Map<String, Object>>> getNetScopeLinks() {
        ...
        {Map<String,Object> svc = new LinkedHashMap<>(); svc.put("service","employee-service"); List<Map<String,Object>> deps = new ArrayList<>();
        Map<String,Object> ddepartmentservice = new LinkedHashMap<>(); ddepartmentservice.put("name","department-service"); ddepartmentservice.put("grpcPort",18085); ddepartmentservice.put("protocol","NetScope/gRPC"); ddepartmentservice.put("portConvention","HTTP port + 10000"); deps.add(ddepartmentservice);
        Map<String,Object> dpayrollservice = new LinkedHashMap<>(); dpayrollservice.put("name","payroll-service"); dpayrollservice.put("grpcPort",18082); dpayrollservice.put("protocol","NetScope/gRPC"); dpayrollservice.put("portConvention","HTTP port + 10000"); deps.add(dpayrollservice);
        svc.put("dependencies", deps); netScopeData.add(svc);}
        {Map<String,Object> svc = new LinkedHashMap<>(); svc.put("service","leave-service"); List<Map<String,Object>> deps = new ArrayList<>();
        Map<String,Object> dpayrollservice = new LinkedHashMap<>(); dpayrollservice.put("name","payroll-service"); dpayrollservice.put("grpcPort",18082); dpayrollservice.put("protocol","NetScope/gRPC"); dpayrollservice.put("portConvention","HTTP port + 10000"); deps.add(dpayrollservice);
        Map<String,Object> demployeeservice = new LinkedHashMap<>(); demployeeservice.put("name","employee-service"); demployeeservice.put("grpcPort",18081); demployeeservice.put("protocol","NetScope/gRPC"); demployeeservice.put("portConvention","HTTP port + 10000"); deps.add(demployeeservice);
        svc.put("dependencies", deps); netScopeData.add(svc);}
        {Map<String,Object> svc = new LinkedHashMap<>(); svc.put("service","recruitment-service"); List<Map<String,Object>> deps = new ArrayList<>();
        Map<String,Object> ddepartmentservice = new LinkedHashMap<>(); ddepartmentservice.put("name","department-service"); ddepartmentservice.put("grpcPort",18085); ddepartmentservice.put("protocol","NetScope/gRPC"); ddepartmentservice.put("portConvention","HTTP port + 10000"); deps.add(ddepartmentservice);
        Map<String,Object> demployeeservice = new LinkedHashMap<>(); demployeeservice.put("name","employee-service"); demployeeservice.put("grpcPort",18081); demployeeservice.put("protocol","NetScope/gRPC"); demployeeservice.put("portConvention","HTTP port + 10000"); deps.add(demployeeservice);
        svc.put("dependencies", deps); netScopeData.add(svc);}
                return ResponseEntity.ok(netScopeData);
    }
